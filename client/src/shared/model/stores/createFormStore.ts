...
interface FormActions {
  actions: {
    ...
    setTitle: (json: EditorJSONContent) => void;
    setDescription: (json: EditorJSONContent) => void;
    setQuestion: (question: PartialFormQuestion) => void;
    setQuestionTitle: (questionId: string, value: EditorJSONContent) => void;
    addQuestion: () => void;
...
const useCreateFormStore = create<FormStore>()(
  devtools((set) => {
    return {
      ...createInitialState(),
      actions: {
        ...
        setQuestionTitle: (questionId, value) => {
          set((state) => {
            return {
              questions: {
                ...state.questions,
